...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; SM-J105B Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/[FBAN/EMA;FBLC/pt_BR;FBAV/{str(rr(100,1000))}.0.0.{str(rr(1,50))}.{str(rr(11111,9999999999))};]"
	if ua in ugent:pass
