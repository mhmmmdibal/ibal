...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; m2006c3lg build/qp1a.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(100,300))}.0.0.{str(rr(1,10))}.{str(rr(100,350))};]"
	if ua in ugent:pass
