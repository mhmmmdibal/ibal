...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; HTC U23 Build/1.14.709.2; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,4000))}.0.0.{str(rr(1,400))}.{str(rr(1000,450000))};]"
	if ua in ugent:pass
