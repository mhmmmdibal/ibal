...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (iPhone; U; CPU iPhone OS {versi_chrome} build/{build}; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8L1 Safari/6533.18.5 [FBAN/EMA;FBLC/en_US;FBAV/{str(rr(100,1000))}.0.0.{str(rr(1,50))}.{str(rr(10000,90000))};]"
	if ua in ugent:pass
