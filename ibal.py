...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; XT1080 Build/SU6-7.2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.84 Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(100,300))}.0.0.{str(rr(1,10))}.{str(rr(100,3500))};]"
	if ua in ugent:pass
