...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; RT5 Build/RKQ1.175808.008; ww) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,3000))}.0.0.{str(rr(10,300))}.{str(rr(1000,35000))};]"
	if ua in ugent:pass
